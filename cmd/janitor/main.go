...
func main() {
	...
	UNDESIRED_LABELS := map[string]struct{}{
		// Old priority system, being phased out so not entirely undesired
		// yet (wait until there's no P* labels on
		// https://github.com/orgs/dotmesh-io/projects/1 first)
		/*
			"P0": struct{}{},
			"P1": struct{}{},
			"P2": struct{}{},
		...
		*/
		...
		/* Old review system, proposed for deletion but not confirmed yet

		"code-review":        struct{}{},
		"ready-for-sign-off": struct{}{},
		*/

		/* Github default labels we don't use, so should clean up sometime, but confirm nobody's using them first
